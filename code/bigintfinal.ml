...
*)
    ...
    let rec divrem' dividend pow_of2 divisor =
        if (compare' divisor dividend) = 1
         then [0], dividend
                 ...
                 divrem' dividend (double_bigint pow_of2) (double_bigint divisor)
    ...
    let div (Bigint (neg1, value1)) (Bigint (neg2, value2)) = 
      ...
      let rem (Bigint (neg1, list1)) (Bigint (neg2, list2)) =
        let _, remainder = divrem (Bigint (neg1, list1)) (Bigint (neg2, list2))
         in remainder
    
    (*true = even*)
    let even_odd (Bigint (neg, number)) =
      let _, remainder = rem (Bigint (neg, number)), (Bigint (Pos, [2]))
    ...
    let rec pow' (Bigint (neg1, base)) (Bigint (neg2, exponent)) (Bigint (neg3, result)) = 
      ...
      | (Bigint (neg2, exponent)) when (compare (Bigint (neg2, exponent)) zero) = 0 
        -> (Bigint (neg3, result))
      | (Bigint (neg2, exponent)) when even_odd (Bigint (neg2, exponent)) 
        -> pow' (mul (Bigint (neg1, base)) (Bigint (neg1, base)))
                (div (Bigint (neg2, exponent)) (Bigint (Pos, [2])))
                (Bigint (neg3, result))

      | (Bigint (neg2, exponent)) 
        -> pow' (Bigint(neg1, exponent))
...
(*
    ...
    (*check if args are correct*)
     let divrem (Bigint (neg1, list1)) (Bigint (neg2, list2)) =
...
(*
      let div (Bigint (neg1, list1)) (Bigint (neg2, list2)) =
        let quotient, _  = divrem (Bigint (neg1, list1)) (Bigint (neg2, list2))
        in quotient    
*)
(*
